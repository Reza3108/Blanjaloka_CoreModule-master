        ...
        <div class="row">
            <div class="col-md-6">               
                <div class="row g-2 mb-4">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="input-form-tambah-produk form-control" name="nama_produk" value="{{ old('nama_produk', $produk->nama_produk) }}" placeholder="Masukkan Nama Produk">
                ...
                <div class="row g-2 mb-4">
                    ...
                    <div class="col-sm-8">
                        <select class="input-form-tambah-produk form-select" name="id_kategori" id="id_kategori" required>
                ...
                <div class="row g-2 mb-4">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="input-form-tambah-produk form-control @error('jumlah_produk') is-invalid @enderror" name="jumlah_produk" value="{{ old('jumlah_produk', $produk->jumlah_produk) }}" placeholder="Masukkan stok produkmu yang tersedia">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="input-form-tambah-produk form-control @error('deskripsi_produk') is-invalid @enderror" name="deskripsi_produk" placeholder="Masukkan Deskripsi Produk" rows="5" required>{{ old('deskripsi_produk', $produk->deskripsi_produk) }}</textarea>
            ...
            <div class="col-md-6">
                ...
                <div class="row mb-1">
                    <div class="col-sm-6">
                        <input type="text" class="input-form-tambah-produk form-control @error('harga_jual') is-invalid @enderror" name="harga_jual" value="{{ old('harga_jual', $produk->harga_jual) }}" placeholder="Masukkan harga">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="input-form-tambah-produk form-select @error('satuan') is-invalid @enderror" name="satuan" value="{{ old('satuan', $produk->satuan) }}">
                            <option value="Pcs" {{ $produk->satuan === 'Pcs' ? 'selected' : '' }}>Pcs</option>
                            <option value="Gram" {{ $produk->satuan === 'Gram' ? 'selected' : '' }}>Gram</option>
                            <option value="Kilo Gram" {{ $produk->satuan === 'Kilo Gram' ? 'selected' : '' }}>Kilo Gram</option>
